...
final class ErrorCode
{
     ...
     */
    public const AUTO_FUND_NOT_SUPPORTED = "auto_fund_not_supported";

    /**
     * Once a batch has started processing, it cannot be modified. Attempting to
     * modify it will cause this error.
     */
    public const BATCH_CANNOT_BE_MODIFIED = "batch_cannot_be_modified";
     ...
     */
    public const CARRIER_CONFLICT = "carrier_conflict";
     ...
     */
    public const CARRIER_NOT_CONNECTED = "carrier_not_connected";

    /**
     * The operation you are performing isn't supported by the specified carrier.
     */
    public const CARRIER_NOT_SUPPORTED = "carrier_not_supported";
     ...
     * are not supported.
     */
    public const CONFIRMATION_NOT_SUPPORTED = "confirmation_not_supported";
     ...
     */
    public const FIELD_CONFLICT = "field_conflict";
     ...
     */
    public const FIELD_VALUE_REQUIRED = "field_value_required";
     ...
     */
    public const IDENTIFIER_CONFLICT = "identifier_conflict";

    /**
     * When updating a resource (such as a shipment or warehouse), the ID in the URL
     * and in the request body must match.
     */
    public const IDENTIFIER_MUST_MATCH = "identifiers_must_match";
     ...
     */
    public const INCOMPATIBLE_PAIRED_LABELS = "incompatible_paired_labels";
     ...
     */
    public const INVALID_BILLING_PLAN = "invalid_billing_plan";
     ...
     * instead.
     */
    public const INVALID_CHARGE_EVENT = "invalid_charge_event";
     ...
     */
    public const LABEL_IMAGES_NOT_SUPPORTED = "label_images_not_supported";

    /**
     * This error indicates a problem with your FedEx account. Please contact
     * FedEx to resolve the issue.
     */
    public const METER_FAILURE = "meter_failure";
     ...
     * label.
     */
    public const RETURN_LABEL_NOT_SUPPORTED = "return_label_not_supported";
     ...
     */
    public const TRACKING_NOT_SUPPORTED = "tracking_not_supported";
     ...
     */
    public const VERIFICATION_FAILURE = "verification_failure";

    /**
     * You attempted to perform an operation on multiple shipments from different
     * warehouses. Try performing separate operations for each warehouse instead.
     */
    public const WAREHOUSE_CONFLICT = "warehouse_conflict";
     ...
     */
    public const WEBHOOK_EVENT_TYPE_CONFLICT = "webhook_event_type_conflict";
}
